...
ALTER TABLE oauth_clients ADD COLUMN share_token_id UUID REFERENCES share_tokens(id) ON DELETE CASCADE;
ALTER TABLE oauth_authorization_codes ADD COLUMN share_token_id UUID REFERENCES share_tokens(id) ON DELETE CASCADE;
ALTER TABLE oauth_refresh_tokens ADD COLUMN share_token_id UUID REFERENCES share_tokens(id) ON DELETE CASCADE;
