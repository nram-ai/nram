...
var settingsSchemas = []api.SettingSchema{
	...
	{Key: service.SettingEnrichmentWorkerCountPostgres, Type: "number", DefaultValue: json.RawMessage(`2`), Description: "Number of concurrent enrichment workers when the backend is Postgres. Each worker holds its own LLM and embed slot.", Category: "enrichment_performance", RequiresRestart: true},
