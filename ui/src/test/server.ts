    ...
    if (url.searchParams.get("schema") === "true") {
      return HttpResponse.json({
        data: [
          ...
          {
            key: "ranking.weight.graph_relevance",
            type: "number",
            default_value: 0.2,
            description: "Graph relevance weight",
            category: "ranking",
            min: 0,
            max: 1,
            step: 0.05,
